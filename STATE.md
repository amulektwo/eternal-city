...
## FPS RECORD (latest — THE FUSED CITY, 2026-07-04, LIVE URL: heaven + 3 GLB heroes)

**Desktop** (Seer's MacBook, tier 2 HIGH, visible window, `?hud=fps`):

| Area | FPS | draw calls | tris |
|---|---|---|---|
| Tree of Life Plaza | 60 | 169 | 629k |
| Throne Hall | 60 | 133 | 557k |
| Fountain Court | 60 | 128 | 548k |
| Gate Plaza (REUBEN) | 60 | 116 | 482k |
| Street of Gold | 60 | 158 | 524k |
| Great Sanctuary | 60 | 127 | 524k |
| Waterfall Terrace | 60 | 111 | 473k |

Floor 50 — held everywhere; draw calls DOWN ~10/vantage vs Forge-alone (the heaven's god-ray merge outpaid its own dome). Watchdog: no organic drops.
**Mobile tier** (`?q=med`, tier 1, Forge-alone measurement): 60 fps at Tree Plaza, Street of Gold, Gate Plaza — floor 25 cleared 2.4×. Physical-device pass still outstanding.

Previous records: THE FORGE local 60 everywhere; Ascent Pass 1 goal-gate 57–61.
